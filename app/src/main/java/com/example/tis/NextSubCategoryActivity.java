...
import com.example.tis.adapter.NextSubCategoryListAdapter;
import com.example.tis.breadcrumb.Breadcrumb;
import com.example.tis.dao.NextSubCategoryDAO;
...
public class NextSubCategoryActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{

    private NavigationView navigationView;
    private NextSubCategoryDAO categoryDAO;
    private ArrayList<NextSubCategory> categories;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String subCategory = breadcrumbs.get(0).getSubCategory();

        categoryDAO = new NextSubCategoryDAO(this);
        categories = categoryDAO.findBySubCategory(subCategory);

        NextSubCategoryListAdapter adapter = new NextSubCategoryListAdapter(this,
        ...
        listCategory.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(NextSubCategoryActivity.this, WebActivity.class);
                intent.putExtra("docFileName", categories.get(i).getId().split("_")[1]);
                startActivity(intent);
                overridePendingTransition(R.anim.slidein, R.anim.slideout);
            }
        });
    ...
    public void onBackPressed() {
        ...
        this.finish();
        Intent repair = new Intent(this, SubCategoryActivity.class);
        startActivity(repair);
        overridePendingTransition(R.anim.slidein, R.anim.slideout);
    }
