...
import com.example.tis.adapter.SubCategoryListAdapter;
import com.example.tis.breadcrumb.Breadcrumb;
import com.example.tis.dao.SubCategoryDAO;
...
public class SubCategoryActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String category = breadcrumbs.get(0).getCategory();

        categoryDAO = new SubCategoryDAO(this);
        categories = categoryDAO.findByCategory(category);

        SubCategoryListAdapter adapter = new SubCategoryListAdapter(this,
        ...
        listCategory.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                BreadcrumbList.updateBreadcrumbSubCategory(0, categories.get(i).getId());
                BreadcrumbList.addBreadcrumb(new Breadcrumb(categories.get(i).getTitle(),
                        "NextSubCategoryActivity",
                        breadcrumbs.get(0).getDocument(),
                        breadcrumbs.get(0).getModel(),
                        category,
                        categories.get(i).getId()));
                Intent intent = new Intent(SubCategoryActivity.this, NextSubCategoryActivity.class);
                startActivity(intent);
                overridePendingTransition(R.anim.slidein, R.anim.slideout);
            }
        });
    ...
    public void onBackPressed() {
        ...
        this.finish();
        Intent repair = new Intent(this, CategoryActivity.class);
        startActivity(repair);
        overridePendingTransition(R.anim.slidein, R.anim.slideout);
    }
